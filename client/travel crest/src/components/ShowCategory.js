...
export default class Category extends Component {
  ...
  async componentDidMount() {
   ...
   messaging && messaging.requestPermission()
    ...
    ;
    navigator.serviceWorker &&navigator.serviceWorker.addEventListener("message", (message) => console.log(message)); 
    messaging && messaging.onMessage((payload) => alert('Message received. ', payload));
